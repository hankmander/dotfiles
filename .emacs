...
(custom-set-variables
 ...
 '(safe-local-variable-values
   '((helm-rg-default-glob-string . "!*{.min.,vendor.js,doubly.js,polyfills.js,.svg,yotpo-full-css.css,theme.scss.liquid,airinum.css}*")
     (helm-rg-default-glob-string . "!*{.min.,vendor.js,doubly.js,polyfills.js,.svg,yotpo-full-css.css,theme.scss.liquid}*")
